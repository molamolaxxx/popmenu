...
public class PopMenu {
    ...
    private OnPopMenuCloseListener popMenuCloseListener;
    ...
    private PopMenu(Builder builder) {
        ...
        this.popMenuCloseListener=builder.popMenuCloseListener;
    ...
    private void buildAnimateGridLayout() {
        ...
        mGridLayout.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (null!=popMenuCloseListener)
                    popMenuCloseListener.onClose();
                hide();
                return true;
            }
        });
        mGridLayout.setColumnCount(mColumnCount);
        mGridLayout.setBackgroundColor(Color.parseColor("#660B0B0B"));
        ...
        mCloseIv.setImageResource(R.drawable.cross_circle);
    ...
    public static class Builder {
        ...
        public Builder setCloseListener(OnPopMenuCloseListener listener){
            this.popMenuCloseListener=listener;
            return this;
        }
